---
title: "Racial/Ethnic Disparities in COVID-19 Exposure Risk, Testing, and Cases"
...
load("./test_heat_map_appendix2020-11-30.RData")
print(test_heat_map)
```
...
load("./case_heat_map_appendix2020-11-30.RData")
print(case_heat_map)
```
