...
load("~/Downloads/test_heat_map_appendix2020-11-30 (1).RData")
print(test_heat_map)
```
...
load("~/Downloads/case_heat_map_appendix2020-11-30 (1).RData")
print(case_heat_map)
```
...
out_race <- fread("~/COVID/acs_household_analysis/CA_analysis/PUMA_estimates/puma_estimates_race_withse_insurance_multiocc.csv")
cases <- fread("~/COVID/acs_household_analysis/CA_analysis/paper/cleaned_data/redistributed_population_sensitivity.csv")
...
puma_name_list <- fread("~/COVID/acs_household_analysis/puma_name_list.csv")
...
regions <- fread("~/COVID/acs_household_analysis/CA_analysis/county_to_region_appendix.csv")
...
cases <- fread("~/COVID/acs_household_analysis/CA_analysis/paper/cleaned_data/puma_level_data.csv")
cases <- cases[race_grp=="ALL"]
...
df <- fread("~/COVID/acs_household_analysis/CA_analysis/paper/cleaned_data/appendix_sens_year.csv")
...
out_race <- fread("~/COVID/acs_household_analysis/CA_analysis/PUMA_estimates/puma_estimates_race_withse_insurance_multiocc.csv")
cases <- fread("~/COVID/acs_household_analysis/CA_analysis/paper/cleaned_data/redistributed_final.csv")
...
map_df <- fread("~/COVID/acs_household_analysis/CA_analysis/CA_Vulnerability/puma_map_race.csv")
...
county_outlines <- readRDS("~/COVID/acs_household_analysis/county_map.RDS")
